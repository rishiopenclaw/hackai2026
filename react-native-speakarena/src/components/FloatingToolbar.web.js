...
export default function FloatingToolbarWeb({ state, navigation }) {
  ...
  const slotWidth = 74;
  const indicatorX = 12 + activeIndex * slotWidth;
  ...
  return (
    <>
      ...
      .ft-indicator{position:absolute;top:9px;left:${indicatorX}px;width:50px;height:44px;transition:transform 460ms cubic-bezier(0.34,1.2,0.64,1),left 460ms cubic-bezier(0.34,1.2,0.64,1)}
